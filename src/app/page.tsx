...
const chapters = [
  ...
  ["2004–15", "Scale", "Landmark Group and Max Fashion. Approximately SAR 600 million in sales and buying budgets supported while the Eastern Region grew from 5 to 22 stores."],
  ...
  ["2020–Now", "Reinvention", "Entrepreneurship, marketing execution and digital growth systems across real estate, hospitality, healthcare and local services."],
];
...
const cases = [
  ...
  },
  {
    ...
    text: "Websites, SEO, lead tracking, CRM workflows and performance dashboards built into practical growth foundations across multiple sectors.",
...
const personSchema = {
  ...
  worksFor: { "@type": "Organization", name: "Sri Supraja Infracon" },
    ...
    <>
      ...
      <main id="top">
        <section className="hero">
          <div className="hero-orbit" aria-hidden="true"><span>29</span><i>years</i></div>
          <div className="hero-index" aria-hidden="true">01 / 10</div>
          <div className="hero-content">
            <p className="kicker"><span /> Retail strategy · Digital growth · Business transformation</p>
            <h1><span>Retail intelligence.</span><span>Digital growth.</span><em>Business transformation.</em></h1>
            <div className="hero-lower">
              <p>Anjanna Margam transforms commercial complexity into practical momentum, combining multinational retail planning with modern marketing and digital execution.</p>
          ...
          <div className="portrait-slice">
            <Image src="/images/anjanna-margam.jpg" alt="Anjanna Margam, Marketing Executive, retail strategist and digital growth professional" fill priority sizes="(max-width: 760px) 42vw, 28vw" />
        ...
        <section className="manifesto" id="story">
          <p className="vertical-label">Executive profile</p>
          <div>
            <p className="chapter-no">02</p>
            <h2>Numbers reveal the pattern.<br /><span>Judgement changes the outcome.</span></h2>
            <div className="manifesto-copy">
              <p>Nearly three decades across education, multinational retail, entrepreneurship, marketing and digital growth have shaped one operating belief.</p>
              <p>Understand the numbers. Respect the customer. Build systems people can actually use. Then execute with clarity.</p>
            </div>
          </div>
        </section>

        <section className="current-role" id="current-role">
          <div className="current-role__intro">
            <p className="chapter-no">03 · Current role</p>
            <h2>Experience applied to present-day growth.</h2>
          </div>
          <article className="current-role__card">
            <span>Sri Supraja Infracon</span>
            <h3>Marketing Executive</h3>
            <p>Supporting real estate marketing through practical digital execution, measurable lead systems and stronger coordination between websites, campaigns, CRM workflows and sales follow-up.</p>
            <ul className="current-role__points">
              <li>SEO strategy and website improvement</li>
              <li>Lead generation and campaign coordination</li>
              <li>CRM workflows and lead intelligence</li>
              <li>Performance tracking and analytics</li>
              <li>Brand content and digital assets</li>
              <li>Sales enablement and process improvement</li>
            </ul>
          </article>
        </section>
        ...
        <section className="data-stage" id="impact">
          <div className="data-heading">
            <p className="chapter-no">04 · Evidence</p>
            <h2>Scale, not slogans.</h2>
          </div>
          <div className="data-grid">
            <article className="data-primary"><span>SAR</span><strong>0.6B</strong><p>Approximate sales and buying budget scope supported at Max Fashion, Eastern Region.</p></article>
          ...
          <p className="evidence-note">The figures describe professional planning scope and portfolio representation. They do not imply direct ownership of the stores or budgets.</p>
        </section>

        <section className="world-stage" aria-label="International market experience">
          <div className="world-copy">
            <p className="chapter-no">05 · Across markets</p>
        ...
        <section className="chapters" id="journey">
          <div className="chapters-head"><p className="chapter-no">06 · The journey</p><h2>Four chapters.<br />One continuous reinvention.</h2></div>
        ...
        <section className="capabilities" id="expertise">
          <div className="capability-title"><p className="chapter-no">07 · Capabilities</p><h2>Strategy that remains close to the work.</h2></div>
        ...
        <section className="work" id="work">
          <div className="work-visual">
            ...
            <div><p className="chapter-no">08 · Selected work</p><h2>Commercial discipline.<br />Digital velocity.</h2></div>
          </div>
        ...
        <section className="ventures" id="ventures">
          <div className="ventures-head"><p className="chapter-no">09 · Built, not imagined</p><h2>Ideas moved into the real world.</h2></div>
        ...
        <section className="contact" id="contact">
          <p className="chapter-no">10 · The next chapter</p>
          <h2>Let’s make complexity<br /><em>useful.</em></h2>
          <p className="contact-copy">Open to consulting, advisory, executive and business transformation conversations in retail planning, marketing systems and digital growth.</p>
          <div className="contact-links">
            <a href="https://wa.me/919640753929" target="_blank" rel="noreferrer">Discuss business growth <Arrow /></a>
